...
- **Global scope**: `/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/notes/`)
...
2. Glob `/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/notes/` — works in any directory
