...
```
Agent(
  prompt="Read /Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/get-shit-done/templates/SECURITY.md`
