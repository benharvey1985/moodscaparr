...
```bash
INIT=$(node "/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
