...
```bash
INIT=$(node "/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/get-shit-done/templates/spec.md.
