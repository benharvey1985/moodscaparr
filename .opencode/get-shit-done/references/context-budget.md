...
The keys live in `.claude/settings.json` (project) or `/Users/benharvey/Desktop/CodeProjects/Moodscaparr/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
